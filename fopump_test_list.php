...
$page_subtitle = $department['name'] . ' · F-FIP-02 FOP tester data · one ongoing record per model';
...
<div class="checksheet-card">
    ...
    <div class="form-grid-top" id="form-grid-top">
        ...
        <div class="field-block">
            ...
            <input type="text" id="f_oil_pressure" placeholder="e.g. 5-7">
        </div>
        <div class="field-block">
            <label>Oil Temp.</label>
            <input type="text" id="f_oil_temp">
        </div>
        <div class="field-block">
            <label>Room Temp.</label>
            <input type="text" id="f_room_temp" placeholder="e.g. 28-30° C">
        </div>
        <div class="field-block">
            <label>Start Test Time</label>
            <input type="time" id="f_start_test_time">
        </div>
        <div class="field-block">
            <label>Checker</label>
            <select id="f_checker">
    ...
    <div class="fopump-check-toolbar">
        ...
        <span class="import-hint">One row per unit tested; new rows pre-fill from this model's target spec. Submitting updates this model's record in place — there's no date to track.</span>
    </div>
    ...
    <div class="actions">
        <div class="progress-label" id="fopump-test-status-label"></div>
