...
// An Admin-approved edit request bypasses the "current period only"/"today
// only" locks for this specific month's record — see includes/edit_requests.php.
$unlocked = has_active_unlock($pdo, 'bakeoven', $header_id);
