...
$export_route = 'paint_viscosity_list.php'; $export_dept = $department_id; require __DIR__ . '/includes/export_button.php';
?>
...
<div class="cs-card-list">
    ...
    <div class="cs-card">
        ...
        <?php if (is_admin()): ?>
            <a class="cs-view-btn-sm" href="paint_viscosity_list.php?edit_id=<?= $row['id'] ?>">Edit</a>
        <?php else: ?>
